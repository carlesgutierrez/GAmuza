...
class ofxControlPanel: public guiBaseObject{
	...
	public:
		...
		guiTypeChartPlotter * addChartPlotter(string name, guiStatVarPointer varPtr, float width, float height, int maxNum, float minYVal, float maxYVal, bool _strech=false);
