...
class sourceTracking: public ofBaseApp, public ofxCvBlobListener{
	...
	public:
			...
			ofVec4f					*_kalman_ftInfo;								// kalman filtered tracking blobs info
			ofxCvKalman				*kFtInfoX[MAX_NUM_CONTOURS_TO_FIND];
